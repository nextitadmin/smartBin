...
export class ResidentReportController {
    ...
    async getReports(@AuthenticatedResident() resident: ResidentUser, @Query() filters: GetReportsDto) {
        const reports = await this.reportService.getReportsByUser(resident, filters);
